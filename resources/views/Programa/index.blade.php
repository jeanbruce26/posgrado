                                        ...
                                        <form action="{{ route('Programa.store') }}" method="POST">
                                            ...
                                            <div class="col-sm-12 row g-3">
                                                <div class="mb-3 col-md-12">
                                                    <label for="inputPrograma" class="form-label">Programa <span class="text-danger">*</span></label>
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap table-bordered dt-responsive text-dark" id="tablaPrograma">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('Programa.update',$item->id_programa) }}" method="POST">
                                                                    ...
                                                                    <div class="col-sm-12 row g-3">
                                                                        ...
                                                                        <div class="mb-3 col-md-12">
                                                                            <label for="inputPlan" class="form-label">Sede <span class="text-danger">*</span></label>
