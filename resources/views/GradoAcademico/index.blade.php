                                    ...
                                    @csrf
                                        <div class="modal-body row g-3">
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="inputGradoAca" name="nom_grado" maxlength="45" onkeypress="return soloLetras(event)">
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            @csrf @method('PUT')
                                                                <div class="modal-body row g-3">
                                                                    <div class="mb-3 col-md-12">
                                                                        <label for="inputGradoAca" class="form-label">Grado Académico</label>
                                                                        <input type="text" class="form-control" id="inputGradoAca" name="nom_grado" value="{{ $item->nom_grado }}" onkeypress="return soloLetras(event)">
                                                                    </div>
