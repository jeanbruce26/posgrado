<div>
    ...
    <div class="alert alert-primary alert-dismissible alert-label-icon label-arrow shadow fade show mb-4" role="alert">
        <i class="ri-information-line label-icon"></i><strong>Recuerde</strong> - Una vez realizado la evaluación, no podrá realizar modificación de las notas ingresadas.
        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
    </div> --}}
    <!-- Primary Alert -->
    <div class="alert alert-info alert-dismissible alert-additional shadow fade show" role="alert">
        ...
        <div class="alert-content">
            <p class="mb-0">- El puntaje minimo para aprobar la evaluación de expediente es de {{ number_format($puntaje->puntaje_minimo_expediente) }} puntos.</p>
        </div>
    </div>
    @php
