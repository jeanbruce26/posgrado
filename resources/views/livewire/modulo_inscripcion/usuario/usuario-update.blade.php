            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if (session()->has('error'))
                        <div class="alert alert-danger alert-border-left alert-dismissible fade shadow show fw-bold" role="alert">
                    ...
                    <div class="card-text mx-3 mt-2">
                        <h5><strong class="text-uppercase">Documentos ingresados en el proceso de inscripción</strong></h5>
                    </div>
                    <div class="card-text mx-3 my-2 d-flex justify-content-around row g-3">
