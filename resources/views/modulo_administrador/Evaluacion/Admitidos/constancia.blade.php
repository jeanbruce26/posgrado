...
<body>
    <table class="table" style="width:100%; padding-right: 1rem; padding-left: 1rem; padding-bottom: 2.5rem; padding-top: 2.5rem;">
        <thead>
            <tr>
                <th>
    ...
    <div style="padding: 3rem; text-align: center; font-size: 3rem; font-weight: bold; font-family: 'Varela Round', sans-serif; color: rgb(40, 49, 132)">
        Constancia de Ingreso
    </div>

    <div style="padding-right: 7rem; padding-left: 7rem; padding-top: 2.7rem; font-weight: bold; font-size: 1.2rem; text-align: center;">
