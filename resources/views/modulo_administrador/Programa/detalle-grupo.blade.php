...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    <h4 class="mb-sm-0">Admitidos de los Grupos</h4>
...
@livewire('modulo-administrador.gestion-curricular.programa.detalle-grupo', ['id_grupo_programa' => $id_grupo_programa, 'id_mencion' => $id_mencion])
