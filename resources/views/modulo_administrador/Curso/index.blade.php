...
<div class="page-title-box d-sm-flex align-items-center justify-content-between">
    <h4 class="mb-sm-0">Cursos - {{ $titulo }}</h4>
...
@livewire('modulo-administrador.gestion-curricular.programa.curso', ['mencion_id' => $mencion_id])
...
<script>
    window.addEventListener('modalCurso', event => {
        $('#modalCurso').modal('hide');
    })

    window.addEventListener('notificacionCurso', event => {
        Toastify({
