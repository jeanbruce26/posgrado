...
@section('content')
    ...
    @livewire('modulo-administrador.expediente.index')
...
@section('javascript')
    ...
    window.addEventListener('notificacionExpediente', event => {
        Toastify({
    ...
    window.addEventListener('alertaConfirmacionExpediente', event => {
        ...
        Swal.fire({
            title: '¿Estás seguro de modificar el estado del Expediente?',
            text: "",
            icon: 'question',
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-administrador.expediente.index', 'cambiarEstado', event.detail.id);
            }
        })
    })
    </script>
