...
@livewire('modulo-coordinador.vista-docente.evaluacion.entrevista', ['evaluacion_id' => $id, 'tipo_evaluacion_id' => $tipo])
    ...
    window.addEventListener('alertaConfirmacionEntrevista', event => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-coordinador.vista-docente.evaluacion.entrevista', event.detail.metodo);
            }
        })
    })
