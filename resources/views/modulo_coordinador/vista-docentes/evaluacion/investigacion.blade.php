...
@livewire('modulo-coordinador.vista-docente.evaluacion.investigacion', ['evaluacion_id' => $id, 'tipo_evaluacion_id' => $tipo])
    ...
    window.addEventListener('alertaConfirmacionInvestigacion', event => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Livewire.emitTo('modulo-coordinador.vista-docente.evaluacion.investigacion', event.detail.metodo);
            }
        })
    })
