                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span
                                            class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Evaluador</span>
                                        <span
                                            class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">
                                            {{ auth('evaluacion')->user()->usuario_evaluacion_correo }}
                                        </span>
                                    </span>
                                </span>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{ route('coordinador.auth.logout') }}"
                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                    <i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i>
                                    {{ __('Cerrar sesión') }}
                                </a>

                                <form id="logout-form" action="{{ route('coordinador.auth.logout') }}" method="POST"
                                    class="d-none">
                                    @csrf
                                </form>
                            </div>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link fw-bold" href="{{ route('coordinador.docente.programas.index') }}" role="button"
                        ...
                        {{-- <li class="nav-item">
                            <a class="nav-link menu-link fw-bold" href="{{ route('coordinador.modulo-inscripcion-index.index') }}" role="button"
                                aria-expanded="false" aria-controls="sidebarDashboard">
                                <i class="mdi mdi-clipboard-file-outline"></i> <span data-key="t-apps">Datos de Inscritos</span>
                            </a>
                        </li>
                        <li class="nav-item">
