...
class ExportAdmitidosMatriculados implements FromCollection, WithTitle, WithHeadings, WithEvents
{
    protected $id_grupo_programa;
    protected $grupo;

    public function __construct($id_grupo_programa, $grupo)
    {
        $this->id_grupo_programa = $id_grupo_programa;
        $this->grupo = $grupo;
    }
